...
namespace QL_BanHang.View
{
    public partial class frmHoaDon : Form
    {
        ...
        {
            NhanVienCtr khctr = new NhanVienCtr();
            cmbNhanVien.DataSource = khctr.GetData();
        ...
        private void LoadcmbHH()
        {
            ...
            cmbHH.DisplayMember = "TenXe";
            cmbHH.ValueMember = "MaXe";
        ...
        private bool kiemtraSL(string mahh, int sl)
        {
            ...
            dt = hhctr.GetData("Where MaXe = '" + cmbHH.SelectedValue.ToString() + "' and SoLuong>= "+sl);
            if (dt.Rows.Count > 0)
                return true;
            return false;
        }
        ...
        {
            DataTable dt = new DataTable();
            dt = hhctr.GetData("Where MaXe = '" + cmbHH.SelectedValue.ToString() + "'");
            if (dt.Rows.Count > 0)
            {
