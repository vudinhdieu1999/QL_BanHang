...
namespace QL_BanHang.Model
{
    class ChiTietMod
    {
        ...
        public DataTable GetData(string ma)
        {
            ...
            cmd.CommandText = @"select ct.MaHD, hh.TenXe HangHoa, ct.SoLuong, ct.DonGia, ct.SoLuong*ct.DonGia ThanhTien from tb_CTHD ct, tb_Xe hh where ct.Ma_Xe = hh.MaXe and MaHD = '" + ma + "'";
